 ...
 * @author Eipusino
 */
public class CharList implements CharSequence, Appendable, Cloneable {
	public char[] items;
	public int size;
	...
	public CharList copy() {
		try {
			CharList out = (CharList) super.clone();
	...
	public void addAll(CharList array) {
		addAll(array.items, 0, array.size);
	}

	public void addAll(CharList array, int offset, int length) {
	...
	public CharList subSequence(int start, int end) {
		...
		if (start == end) return new CharList(0);

		CharList out = new CharList(end - start);
	...
	public boolean equals(Object o) {
		...
		if (!ordered || !(o instanceof CharList array) || !array.ordered) return false;
