...
public class CollectionObjectSet<E> extends AbstractSet<E> implements Cloneable {
	public int size;
	...
	public CollectionObjectSet<E> select(Predicate<E> predicate) {
		CollectionObjectSet<E> arr = new CollectionObjectSet<>(keyComponentType);
		for (E e : this) {
			if (predicate.test(e)) arr.add(e);
		}
		return arr;
	}
