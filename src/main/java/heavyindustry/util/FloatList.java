 ...
 * @author Eipusino
 */
public class FloatList implements Cloneable {
	public float[] items;
	public int size;
	...
	public CollectionList<Vec2> toVec2Array() {
		CollectionList<Vec2> out = new CollectionList<>(size / 2, Vec2.class);
	...
	public FloatList copy() {
		try {
			FloatList out = (FloatList) super.clone();
			out.items = new float[size];
	...
	public void addAll(FloatList array) {
		addAll(array.items, 0, array.size);
	}

	public void addAll(FloatList array, int offset, int length) {
	...
	public int hashCode() {
		...
		int hash = 1;
		for (int i = 0, n = size; i < n; i++)
			hash = hash * 31 + Float.floatToIntBits(items[i]);
		return hash;
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof FloatList array)) return false;
