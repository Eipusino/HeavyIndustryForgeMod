...
@Mod(HeavyindustryMod.MODID)
public final class HeavyindustryMod {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "heavyindustry";
    ...
    public HeavyindustryMod(FMLJavaModLoadingContext context) {
        ...
        BuildCreativeModeTabContentsEvent.BUS.addListener(HeavyindustryMod::addCreative);
